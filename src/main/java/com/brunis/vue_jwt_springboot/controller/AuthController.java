...
import com.brunis.vue_jwt_springboot.payload.request.LoginRequest;
import com.brunis.vue_jwt_springboot.payload.request.SignupRequest;
import com.brunis.vue_jwt_springboot.repo.RoleRepo;
import com.brunis.vue_jwt_springboot.repo.UserRepo;
import com.brunis.vue_jwt_springboot.security.jwt.JwtUtils;
...
import ru.basis_intellect.smis_vue.payload.response.JwtResponse;
import ru.basis_intellect.smis_vue.payload.response.MessageResponse;
            ...
            strRoles.forEach(role -> {
                switch (role) {
                    case "admin":
                        ...
                        break;
                    case "mod":
                        Role modRole = roleRepository.getByName(ERole.ROLE_SYSADMIN)
                                .orElseThrow(() -> new RuntimeException("Error: Role is not found."));
                        roles.add(modRole);
